...
import os
print([x for x in os.walk("../test_files/img2img_basic.png")])

class TestImg2ImgWorking(unittest.TestCase):
    def setUp(self):
        self.url_img2img = "http://localhost:4020/sdapi/v1/img2img"
        self.simple_img2img = {
            "init_images": [encode_pil_to_base64(Image.open(r"../test_files/img2img_basic.png"))],
            "resize_mode": 0,
    ...
    def test_inpainting_masked_performed(self):
        self.simple_img2img["mask"] = encode_pil_to_base64(Image.open(r"../test_files/mask_basic.png"))
        self.assertEqual(requests.post(self.url_img2img, json=self.simple_img2img).status_code, 200)
